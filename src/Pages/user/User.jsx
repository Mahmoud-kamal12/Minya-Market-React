        ...
        <div className="User">
            ...
            <div className="UserContainer">
                ...
                <div className="UserUpdate">
                    ...
                    <button className="BtnDownload"><Icon className="fa fa-download cutoum-icon" color="primary" />Download As PDF</button>
                    <button className="BtnDownload"><Icon className="fa fa-download cutoum-icon" color="primary" />Download As XLS</button>
                    </div>
                </div>
            </div>
        </div>
